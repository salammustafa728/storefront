    ...
    <div id='simple-cart'>
      ...
      <h2>Your Cart Content:</h2>
        {state.cartItemsProducts.map((product,idx) => (
          ...
          <p align="right" id='li'>    {product}
           <Button  id='Button'  variant="contained" style={{backgroundColor: "cadetblue", color:"white"}} onClick={() => deleteHandler(product)}>Delete</Button> </p>
